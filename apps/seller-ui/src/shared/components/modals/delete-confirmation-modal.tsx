    ...
    <div className='fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center'>
        <div className="bg-gray-800 p-6 rounded-lg w-[450px] shadow-lg">
            ...
            <p className="text-gray-300 mt-4">
                ...
                <br/>
                This product will be removed to a **deleted state** and permenantly removed **after 24 hours**. You can recover it within this time.
            </p>

            {/* Action Buttons */}
            <div className="flex justify-end gap-3 mt-6">
                <button onClick={onClose} className='bg-gray-600 hover:bg-gray-700 px-4 py-2 rounded-md text-white transition'>
                    Cancel
                </button>
                <button 
