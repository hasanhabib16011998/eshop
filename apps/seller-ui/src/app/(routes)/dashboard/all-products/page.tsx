...
const ProductList = () => {
    ...
    const columns = useMemo(() => [
        ...
        },
        {
            ...
            header: "Stock",
            cell: ({ row }: any) => (
                <span className={row.original.stock < 10 ? "text-red-500" : "text-white"}>{row.original.stock}</span>
            )
        ...
        },
        {
            ...
            header: "Rating",
            cell: ({ row }: any) => (
                <div className="flex items-center gap-1 text-yello-400">
