                           ...
                           <div className="mt-2">
                            ...
                            <div className='flex flex-col gap-3'>
                                ...
                                {properties.map((property,index)=> (
                                    <div className="border border-gray-700 p-3 rounded-lg bg-gray-900">
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                    <Input
                                    placeholder='Enter property label(e.g., Material, Warrenty)'
                                    value={newLabel}
                                    onChange={(e:any)=>setNewLabel(e.target.value)}
                                    />
                                    <button type="button" className="px-3 py-2 bg-blue-500 text-white rounded-md flex items-center" onClick={addProperty}>
                                        <Plus size={16}/>Add
                                    </button>
                                </div>
                            </div>
                            ...
                            {errors.customProperties && (
                                <p className='text-red-500 text-xz mt-1'>
