                    ...
                    <div className="flex gap-3 flex-wrap">
                        {[...defaultColors, ...customColors].map((color) => {
                            ...
                            return <button
                                ...
                                className={`w-7 h-7 p-2 rounded-md my-1 flex itemns-center justify-center border-2 transition ${isSelected ? "scale-110 border-white" : "border-transparent"} ${isLightColor ? "border-gray-600" : ""}`}
